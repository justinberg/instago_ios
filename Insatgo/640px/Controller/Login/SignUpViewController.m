...
- (void)viewDidLoad {
    ...
    [self.signUpView setContentMode:UIViewContentModeScaleAspectFill];
    [self.signUpView setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"back-login-s.png"]] ];
    [self.signUpView setLogo:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"logoz.png"]]];
    
    
    
    // Change button apperance
    [self.signUpView.dismissButton setImage:[UIImage imageNamed:@"Exit.png"] forState:UIControlStateNormal];
    [self.signUpView.dismissButton setImage:[UIImage imageNamed:@"Exit.png"] forState:UIControlStateHighlighted];
    ...
    [self.signUpView.additionalField setPlaceholder:@"Dispaly name"];
