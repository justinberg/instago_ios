...
@property (nonatomic,strong) UIView *spamView;
...
- (void)createView {
    ...
    [self.photographer fetchIfNeededInBackgroundWithBlock:^(PFObject *object, NSError *error) {
        ...
        [userButton setTitleColor:[UIColor colorWithRed:92.0f/255.0f green:163.0f/255.0f blue:225.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
    ...
    likeBarView = [[UIView alloc] initWithFrame:CGRectMake(likeBarX, likeBarY, likeBarWidth, likeBarHeight)];
     //[likeBarView setBackgroundColor:[UIColor colorWithRed:92.0/255.0 green:163.0/255.0 blue:225.0/255.0 alpha:0.9f]];
