...
@property (nonatomic,strong) UIImageView *myFeel;
@property (nonatomic,strong) UIColor *colr;
@end
...
- (id)initWithFrame:(CGRect)frame buttons:(PAPPhotoHeaderButtons)otherButtons {
    ...
    if (self) {
        ...
        if (self.buttons & PAPPhotoHeaderButtonsComment) {
            ...
            [self.commentButton setFrame:CGRectMake( 282.0f, 10.0f, 29.0f, 28.0f)];
            [self.commentButton setBackgroundColor:[UIColor clearColor]];
            [self.commentButton setTitle:@"" forState:UIControlStateNormal];
            [self.commentButton setTitleColor:[UIColor colorWithRed:28.0f/255.0f green:54.0f/255.0f blue:103.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
        ...
        if (self.buttons & PAPPhotoHeaderButtonsLike) {
            ...
            [self.likeButton setFrame:CGRectMake(246.0f, 8.0f, 29.0f, 29.0f)];
            [self.likeButton setBackgroundColor:[UIColor clearColor]];
            [self.likeButton setTitle:@"" forState:UIControlStateNormal];
            [self.likeButton setTitleColor:[UIColor colorWithRed:28.0f/255.0f green:54.0f/255.0f blue:103.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
        ...
        if (self.buttons & PAPPhotoHeaderButtonsUser) {
            ...
            [self.userButton setTitleColor:[UIColor colorWithRed:28.0f/255.0f green:102.0f/255.0f blue:166.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
        ...
        [self.timestampLabel setTextColor:[UIColor colorWithRed:28.0f/255.0f green:54.0f/255.0f blue:103.0f/255.0f alpha:1.0f]];
        ...
        self.myFeel = [[UIImageView alloc] initWithFrame:CGRectMake(200, 3, 40, 40)];
        [containerView addSubview:self.myFeel];
        //[self.myFeel setBackgroundColor:[UIColor blackColor]];
        _myFeel.layer.cornerRadius = 12;
        _myFeel.clipsToBounds = YES;
        
        CALayer *layer = [containerView layer];
        layer.backgroundColor = [[UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:0.9f] CGColor];
...
- (void)setPhoto:(PFObject *)aPhoto {
    ...
    NSString *em = [self.photo objectForKey:@"feel"];
    [self.myFeel setImage:[UIImage imageNamed:em]];
    
    
    
    
    [self.myFeel setBackgroundColor:_colr];
